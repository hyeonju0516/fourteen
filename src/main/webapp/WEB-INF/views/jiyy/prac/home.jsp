...
<main>
		...
		<div class="sc-inner about">
			<div class="sc-contents">
				<div class="about-service-item">
					<div class="item-img">
						<img src="/resources/img/img.png" alt="어바웃 이미지 대용">
					</div>
					<div class="item-desc">
						<h4>Lorem</h4>
		...
		<div class="border-box">
			...
			<div class="swiper-wrapper">
				...
				<div class="slide-contents">
					...
					<div class="item-img">
					<img src="/resources/img/img.png" alt="아이템 이미지">
					</div>
				</div>
				</div>
				<div class="swiper-slide">
	...
	<div class="sc-inner">
		...
		<div class="skills">
			...
			<img src="/resources/img/img.png" alt="기능 이미지">
			</div>
...
<script src="/resources/js/main02.js"></script>
<%@ include file="/WEB-INF/include/tiles/include-footer.jsp"%>
<script>
	AOS.init();
</script>
</body>
