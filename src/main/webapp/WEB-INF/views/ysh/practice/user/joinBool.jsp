...
<script>
function idDoubleCheckBool() {
    alert('idDoubleCheckBool 진입');

    $.ajax({
        url : '/yshPractice/user/idDoubleCheckBool',
        type : 'GET',
        data : 'userId=' + $('#userId').val(),
        success : function(data) {
            console.log('data :' + data)
            if(data) {
                alert('중복된 아이디 입니다. 다시 입력해주새요.');
            } else {
                alert('사용가능한 아이디 입니다.');
                $('#userPw').focus();
            }
    ...
    <form name="join" id="join" action="#" method="post">
        <div>
            ...
            <div>
                ...
                <button type="button" onclick="idDoubleCheckBool();">중복 확인</button>
            </div>
