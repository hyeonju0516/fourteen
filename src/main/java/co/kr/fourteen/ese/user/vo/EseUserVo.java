package co.kr.fourteen.ese.user.vo;
...
public class EseUserVo implements Serializable {
	...
	private Integer registNo;						// 고유 번호
	private String userId;							// 아이디
	private String userPw;							// 핸드폰 번호
	private String tmprPwNo; 						// 임시비밀번호
	private String userNm;							// 이름
	private String userEmail;						// 이메일
	private String userDomail;						// 이메일 도메인 주소
	...
	private String hiddenPw;						// 암호화 비밀번호
